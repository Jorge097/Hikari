                            ...
                            <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
                                ...
                                <ul className="space-y-3">
                                    ...
                                    <li>
                                        <Link
                                            href={route('velas')}
                                            className={!filters.category ? 'text-orange-600 font-bold' : 'text-neutral-500 hover:text-orange-600'}
                                        >
                                            Todas
                                        </Link>
                                    </li>
                                    ...
                                    {categories.map((cat) => (
                                        ...
                                        <li key={cat.id}>
                                            <Link
                                                href={route('velas', { category: cat.slug })}
                                                className={filters.category === cat.slug
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                                ...
                                {products.map((product) => (
                                    ...
                                    <Link
                                        ...
                                        className="group relative bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100 hover:shadow-md transition"
                                    >
                                        ...
                                        <div className="aspect-square relative overflow-hidden bg-gray-100">
                                            ...
                                            <img
                                                ...
                                                onError={(e) => {
                                                    e.target.src = "https://placehold.co/400x400/orange/white?text=Sin+Foto"
                                                }}
                                            />
                                        ...
                                        <div className="p-5">
                                            ...
                                            <p className="mt-2 text-x2 text-neutral-800">
                                                {product.size}
                                            </p>
